...
<!--products-->
	...
	if (isset($_POST['user_name']) && isset($_POST['user_password']))
	{
		...
		$frgt_password=$_POST['frgt'];
		$result = mysqli_query($conn,"SELECT username,mobile,email,ques FROM users WHERE (username='$username' OR mobile='$mobile' OR email='$email' OR ques='$frgt_password')");
		if ($result && mysqli_num_rows($result) > 0)
		{
				...
				{
						$sql = "Insert into users (username,password,mobile,email,ques) values  ('$username','$password','$mobile','$email','$frgt_password')";
